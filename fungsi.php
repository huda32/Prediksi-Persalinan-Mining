...
function can_access_menu($menu){
    if($_SESSION['prediksilahir_c45_level']==2 & $menu=='olah_data'){// || $menu=='view_rule')){
        return false;
    }
    if($_SESSION['prediksilahir_c45_level']==2 & $menu=='data_mining'){
        return false;
    }
    if($_SESSION['prediksilahir_c45_level']==2 & $menu=='uji_rule'){
        return false;
    }
    return true;
}
